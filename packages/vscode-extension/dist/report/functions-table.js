...
function FunctionsTable(filePath, functions) {
    const rows = functions.map((f) => [
        ...
        f.sloc,
        f.params,
        (0, metric_formatter_1.formatMetric)(f.cyclomatic, 6, 10),
        (0, metric_formatter_1.formatMetric)(f.difficulty),
...
exports.default = FunctionsTable;
//# sourceMappingURL=functions-table.js.map